...
class DemoAppDataSeeder extends Seeder
{
    ...
    private function instituteSettingsData()
    {
        ...
        $data['name'] = 'School ASRG';
        $data['short_name'] = 'ASRG';
        $data['establish'] = '2010';
        $data['website_link'] = 'http://asrgtechnology.com';
        $data['email'] = 'sales@asrgtechnology.com';
        $data['phone_no'] = '+918882107147';
        $data['address'] = 'Ramnagar,Bihar-845106';
